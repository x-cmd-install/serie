...
![serie](https://repo.x-cmd.io/serie.svg?lang=zh)
...
合计: **11,529** 行代码（覆盖前 5 种语言、共 **55** 个文件）。
...
- **最新版本**: `v0.9.0` (2026-09-06)
- **最近提交**: 2026-09-08
- **Release 含资产**: 6 个

## 流行度

- **Star**: 2,094 · **Fork**: 55 · **开放 issue**: 52 · **贡献者**: 15

## 累计统计

- **发布数**: 30 · **已合并 PR**: 103 · **开放 PR**: 9 · **已关闭 issue**: 37 · **开放 issue**: 15 · **提交数**: 226

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 2 | 8 | 1 | 0 | 1 | 10 |
| last60d | 2026-07-14 | 3 | 9 | 1 | 0 | 1 | 13 |
| 90d | 2026-06-14 | 3 | 9 | 1 | 0 | 1 | 13 |
| last180d | 2026-03-16 | 6 | 24 | 3 | 0 | 4 | 34 |
| 360d | 2025-09-17 | 16 | 54 | 7 | 9 | 6 | 96 |
| last720d | 2024-09-22 | 24 | 74 | 8 | 22 | 11 | 171 |
...
在 [repology.org](https://repology.org/project/serie) 上共有 **20** 个发行版报告此项目。**9** 个 ✅ 已是最新上游版本，**10** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260912.yml` · 2026-09-12T04:26:15Z._
